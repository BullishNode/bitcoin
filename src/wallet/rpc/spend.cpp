        ...
        HELP_REQUIRING_PASSPHRASE,
                {
                    ...
                    {"allow_unsafe_inputs", RPCArg::Type::BOOL, RPCArg::Default{false}, "Allow using untrusted inputs in the transaction."},
                },
                {
                ...
                RPCExamples{
                    ...
                    + "\nSend 0.5 BTC allowing unsafe inputs\n"
                    + HelpExampleCli("-named sendtoaddress", "address=\"" + EXAMPLE_ADDRESS[0] + "\" amount=0.5 allow_unsafe_inputs=true")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    // Set whether to allow unsafe inputs
